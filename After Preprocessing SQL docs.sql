...
#__________________________________________Handle Outliers_________________________________________________
   ...
   WITH quartiles AS (
    SELECT 
        ...
        MAX(CASE WHEN ntile_4 = 1 THEN UNIT1_INV1_Power END) AS q1_col1,
        MAX(CASE WHEN ntile_4 = 3 THEN UNIT1_INV1_Power END) AS q3_col1,
        MAX(CASE WHEN ntile_4 = 1 THEN UNIT1_INV2_Power END) AS q1_col2,
        MAX(CASE WHEN ntile_4 = 3 THEN UNIT1_INV2_Power END) AS q3_col2,
        MAX(CASE WHEN ntile_4 = 1 THEN UNIT2_INV1_Power END) AS q1_col3,
        MAX(CASE WHEN ntile_4 = 3 THEN UNIT2_INV1_Power END) AS q3_col3,
        MAX(CASE WHEN ntile_4 = 1 THEN UNIT2_INV2_Power END) AS q1_col4,
        MAX(CASE WHEN ntile_4 = 3 THEN UNIT2_INV2_Power END) AS q3_col4,
        MAX(CASE WHEN ntile_4 = 1 THEN GII END) AS q1_col5,
        MAX(CASE WHEN ntile_4 = 3 THEN GII END) AS q3_col5,
        MAX(CASE WHEN ntile_4 = 1 THEN `MODULE TEMP.1` END) AS q1_col6,
        MAX(CASE WHEN ntile_4 = 3 THEN `MODULE TEMP.1` END) AS q3_col6,
        MAX(CASE WHEN ntile_4 = 1 THEN RAIN END) AS q1_col7,
        MAX(CASE WHEN ntile_4 = 3 THEN RAIN END) AS q3_col7,
        MAX(CASE WHEN ntile_4 = 1 THEN `AMBIENT TEMPRETURE` END) AS q1_col8,
        MAX(CASE WHEN ntile_4 = 3 THEN `AMBIENT TEMPRETURE` END) AS q3_col8
    FROM (
        SELECT 
...
SELECT
    ...
    -- Min-Max Scaling with Aliases
    (UNIT1_INV1_Power - min_UNIT1_INV1) / (max_UNIT1_INV1 - min_UNIT1_INV1) AS scaled_UNIT1_INV1_Power,
    (UNIT1_INV2_Power - min_UNIT1_INV2) / (max_UNIT1_INV2 - min_UNIT1_INV2) AS scaled_UNIT1_INV2_Power,
    (UNIT2_INV1_Power - min_UNIT2_INV1) / (max_UNIT2_INV1 - min_UNIT2_INV1) AS scaled_UNIT2_INV1_Power,
    (UNIT2_INV2_Power - min_UNIT2_INV2) / (max_UNIT2_INV2 - min_UNIT2_INV2) AS scaled_UNIT2_INV2_Power,
    (GII - min_GII) / (max_GII - min_GII) AS scaled_GII,
    (`MODULE TEMP.1` - min_ModuleTemp) / (max_ModuleTemp - min_ModuleTemp) AS scaled_ModuleTemp,
    (RAIN - min_RAIN) / (max_RAIN - min_RAIN) AS scaled_RAIN,
    (`AMBIENT TEMPRETURE` - min_AmbientTemp) / (max_AmbientTemp - min_AmbientTemp) AS scaled_AmbientTemp
